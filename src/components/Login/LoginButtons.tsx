...
const providers = [
    ...
    {   
        ...
        label: "Google", 
        className: "h-6 w-6",
        link : "https://www.svgrepo.com/show/506498/google.svg"
    },
    {   
        id: "discord", 
        label: "Discord", 
        className: "h-6 w-6",
        link : "https://www.svgrepo.com/show/394116/discord.svg"
    },
]
...
className="py-2 px-4 max-w-md flex justify-center items-center bg-gray-600 hover:bg-gray-700 
            focus:ring-gray-500 focus:ring-offset-gray-200 text-white w-full transition ease-in duration-200 
